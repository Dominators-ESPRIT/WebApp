...
class CompetitionController extends AbstractController
{
    ...
    /**
     * @Route("/{refCompetition}", name="competition_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{refCompetition}/edit", name="competition_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{refCompetition}", name="competition_delete", methods={"POST"})
     */
    public function delete(Request $request, Competition $competition): Response
    {
        if ($this->isCsrfTokenValid('delete'.$competition->getRefCompetition(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
