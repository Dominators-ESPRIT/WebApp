 ...
 */
final class Version20210418161319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE codepromo CHANGE label label INT NOT NULL');
        $this->addSql('ALTER TABLE oeuvre MODIFY ref INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE oeuvre ADD ref_id INT DEFAULT NULL, DROP fk_id_portfolio, DROP id_panier, DROP dispo, CHANGE description description VARCHAR(255) NOT NULL, CHANGE date_ajout date_ajout DATE NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE ref id INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('ALTER TABLE oeuvre ADD PRIMARY KEY (id)');
        $this->addSql('DROP INDEX fk_idcodepromo ON panier');
        $this->addSql('ALTER TABLE panier ADD id INT AUTO_INCREMENT NOT NULL, CHANGE id_panier id_panier INT NOT NULL, CHANGE id_codepromo id_codepromo INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('DROP INDEX fk_id_user ON portfolio');
        $this->addSql('ALTER TABLE portfolio DROP id_user, CHANGE date_creation date_creation DATE NOT NULL, CHANGE label laabel VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enchere (id_enchere INT AUTO_INCREMENT NOT NULL, prixinit_enchere DOUBLE PRECISION DEFAULT NULL, date_enchere DATE NOT NULL, duree_enchere TIME DEFAULT NULL, coupant DOUBLE PRECISION DEFAULT NULL, id_user INT NOT NULL, id_oeuvre INT NOT NULL, PRIMARY KEY(id_enchere)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE participation_oeuvre (ref_competition INT AUTO_INCREMENT NOT NULL, ref_oc INT NOT NULL, INDEX fk_ref_oc (ref_oc), PRIMARY KEY(ref_competition, ref_oc)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE participer (id INT AUTO_INCREMENT NOT NULL, idEvenement INT NOT NULL, iduser INT NOT NULL, INDEX fk_iduserevenemnt (iduser), INDEX fk_idparev (idEvenement), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE reservation (id_reservation INT AUTO_INCREMENT NOT NULL, id_formation INT NOT NULL, heure INT NOT NULL, nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, date VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, INDEX fk_idformation (id_formation), PRIMARY KEY(id_reservation)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, id_user INT NOT NULL, id_evenement INT NOT NULL, type_vote INT NOT NULL, INDEX fk_iduservote (id_user), INDEX fk_idevenmentt (id_evenement), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE votec (ref_oc INT AUTO_INCREMENT NOT NULL, id_user_vote INT NOT NULL, INDEX vote_ibfk_2 (id_user_vote), PRIMARY KEY(ref_oc, id_user_vote)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE codepromo CHANGE label label VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`');
        ...
        $this->addSql('ALTER TABLE oeuvre DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE oeuvre ADD id_panier INT DEFAULT NULL, ADD dispo INT DEFAULT 1 NOT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE date_ajout date_ajout DATE DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE id ref INT AUTO_INCREMENT NOT NULL, CHANGE ref_id fk_id_portfolio INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE panier DROP id, CHANGE id_panier id_panier INT AUTO_INCREMENT NOT NULL, CHANGE id_codepromo id_codepromo INT DEFAULT NULL');
        $this->addSql('CREATE INDEX fk_idcodepromo ON panier (id_codepromo)');
        $this->addSql('ALTER TABLE panier ADD PRIMARY KEY (id_panier)');
        $this->addSql('ALTER TABLE portfolio ADD id_user INT NOT NULL, CHANGE date_creation date_creation DATETIME DEFAULT \'CURRENT_TIMESTAMP(6)\' NOT NULL, CHANGE laabel label VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`');
