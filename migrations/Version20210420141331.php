 ...
 */
final class Version20210420141331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre DROP date_ajout, DROP fk_id_portfolio, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre ADD date_ajout DATE DEFAULT NULL, ADD fk_id_portfolio INT DEFAULT NULL, CHANGE id id INT NOT NULL');
