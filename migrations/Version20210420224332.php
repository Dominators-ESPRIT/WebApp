 ...
 */
final class Version20210420224332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre DROP date_ajout, DROP fk_id_portfolio');
        $this->addSql('ALTER TABLE oeuvre ADD CONSTRAINT FK_35FE2EFE77482E5B FOREIGN KEY (id_panier_id) REFERENCES panier (id)');
        $this->addSql('ALTER TABLE oeuvre RENAME INDEX fkk_idpanier TO IDX_35FE2EFE77482E5B');
        $this->addSql('DROP INDEX fk_idcodepromo ON panier');
        $this->addSql('ALTER TABLE panier CHANGE etat etat INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre ADD date_ajout DATE DEFAULT NULL, ADD fk_id_portfolio INT DEFAULT NULL');
        $this->addSql('CREATE INDEX fk_oeuvre_portfolio ON oeuvre (fk_id_portfolio)');
        $this->addSql('ALTER TABLE oeuvre RENAME INDEX idx_35fe2efe77482e5b TO fkk_idpanier');
        $this->addSql('ALTER TABLE panier CHANGE etat etat INT DEFAULT 1');
