 ...
 */
final class Version20210420173623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre DROP date_ajout, DROP fk_id_portfolio, DROP id_panier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre ADD date_ajout DATE DEFAULT NULL, ADD fk_id_portfolio INT DEFAULT NULL, ADD id_panier INT DEFAULT NULL');
