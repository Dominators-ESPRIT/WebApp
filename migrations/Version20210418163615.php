 ...
 */
final class Version20210418163615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre ADD ref_id INT DEFAULT NULL, DROP fk_id_portfolio, DROP id_panier, CHANGE description description VARCHAR(255) NOT NULL, CHANGE date_ajout date_ajout DATE NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE ref id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oeuvre DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE oeuvre ADD id_panier INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE date_ajout date_ajout DATE DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE id ref INT AUTO_INCREMENT NOT NULL, CHANGE ref_id fk_id_portfolio INT DEFAULT NULL');
