 ...
 */
final class Version20210419222248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD id INT AUTO_INCREMENT NOT NULL, CHANGE id_panier id_panier INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP id, CHANGE id_panier id_panier INT AUTO_INCREMENT NOT NULL');
