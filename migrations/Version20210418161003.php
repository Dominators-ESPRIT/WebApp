 ...
 */
final class Version20210418161003 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE panier (id_panier INT AUTO_INCREMENT NOT NULL, id_codepromo INT DEFAULT NULL, etat INT NOT NULL, INDEX fk_idcodepromo (id_codepromo), PRIMARY KEY(id_panier)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
